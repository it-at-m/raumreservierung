...
public final class StatusNotificationTransitionMap {
    private static final Map<StatusTransition, MailType> TRANSITION_MAP = Map.ofEntries(
    ...
    private StatusNotificationTransitionMap() {
    }

    public static MailType getMailTypeForTransition(final BookingStatus oldStatus, final BookingStatus newStatus) {
        return TRANSITION_MAP.get(new StatusTransition(oldStatus, newStatus));
    }
}

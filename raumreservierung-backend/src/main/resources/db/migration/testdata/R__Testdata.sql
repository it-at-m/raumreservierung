...
insert into external_person (id, title, company, street_address, postal_code_city, note) values
    -- Deine bisherigen:
    ('123e4567-e89b-12d3-a456-426614174012', 'MR', 'Beispiel IT GmbH', 'Marienplatz 8', '80331 München', 'Vollständig in die LHM-Systemlandschaft (z.B. SAP, Wilma) eingearbeitet und unterstützt die technische Umsetzung der OZG-Vorgaben.'),
    ('123e4567-e89b-12d3-a456-426614174013', 'MS','Externe Berater AG', 'Consultingweg 42', '80807 München', null),
    -- Neue externe Firmen:
    ('123e4567-e89b-12d3-a456-426614174014','MR', 'Tech MUC GmbH', 'Leopoldstraße 12', '80802 München', 'Sichert durch kontinuierliche Dokumentation den Know-how-Transfer an die internen Projektmitglieder in den Referaten.'),
    ('123e4567-e89b-12d3-a456-426614174015','NONE', 'Agile Coaches DE', 'Rosenheimer Str. 145', '81671 München', 'Optimiert agile städtische Prozesse.'),
    ('123e4567-e89b-12d3-a456-426614174016','DIVERSE', 'Bauplanung Süd', 'Sendlinger Tor Platz 1', '80336 München', 'Verfügt über tiefgehende Kenntnisse der Münchner Bauordnung (BayBO) und unterstützt maßgeblich bei komplexen Genehmigungsverfahren.'),
    ('123e4567-e89b-12d3-a456-426614174017','MS', 'Richter Legal Kanzlei', 'Nymphenburger Str. 4', '80335 München', 'Ist umfassend in die Sicherheitsrichtlinien und Datenschutzprotokolle (BayDSG) der Stadtverwaltung eingewiesen.'),
    ('123e4567-e89b-12d3-a456-426614174018','MR', 'Cloud Architects IO', 'Arnulfstraße 21', '80335 München', 'Selten verfügbar.'),
    ('123e4567-e89b-12d3-a456-426614174019','MS', 'Design Studio MUC', 'Schellingstraße 109', '80798 München', null),
    ('123e4567-e89b-12d3-a456-426614174020','DIVERSE', 'Event Pro', 'Gärtnerplatz 2', '80469 München', null),
    ('123e4567-e89b-12d3-a456-426614174021','NONE', 'Audit Partners AG', 'Max-Joseph-Straße 5', '80333 München', null),
    ('123e4567-e89b-12d3-a456-426614174022','MR', 'IT Sec Consult', 'Oskar-von-Miller-Ring 20', '80333 München', null),
    ('123e4567-e89b-12d3-a456-426614174023','MS', 'Zimmermann PR', 'Kaufingerstraße 15', '80331 München', 'Die PR-Agentur fungiert als strategischer Partner bei der Kommunikation komplexer Infrastrukturprojekte der Stadt München. Durch ihre Expertise in der Bürgerbeteiligung und Krisenkommunikation stellt sie sicher, dass Stadtratsbeschlüsse transparent über alle städtischen Kanäle vermittelt werden. Besonders hervorzuheben ist die professionelle Steuerung der Pressearbeit sowie die Erstellung multilingualer Kampagnen, die die Akzeptanz für Großprojekte im urbanen Raum nachhaltig fördern.');
